...
### Scenario 1: Commuter Sprint ([Trek Allant+ 9.9S](/models/trek-allant-9-9-st), 27.5×2.0")
...
### Scenario 2: Fast Mixed Terrain ([Specialized Turbo Vado 5.0](/models/specialized-turbo-vado-5-0-eqt), 27.5×2.2")
...
### Scenario 3: Heavy Rider High Speed ([Ride1Up 700](/models/ride1up-700-series), 27.5×2.2")
...
Select your Class 3 e-bike model — like the [Trek Allant+](/models/trek-allant-9-9-st), [Specialized Turbo Vado](/models/specialized-turbo-vado-5-0-eqt), [RadWagon](/models/rad-power-radwagon-4), or [Ride1Up 700](/models/ride1up-700-series) — input your weight, and the calculator provides PSI optimized for sustained high speeds with appropriate headroom for heat buildup.
