...
Two e-bikes with identical tires and rider weight can require different tire pressures. The reason? **Motor location** affects weight distribution, which determines how much load each tire carries. Popular mid-drive models like the [Trek Allant+](/models/trek-allant-plus-7) and hub-motor models like the [Rad Power RadRunner Plus](/models/rad-power-radrunner-plus) each have unique PSI requirements.
