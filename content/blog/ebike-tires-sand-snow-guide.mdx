...
Standard pavement PSI advice is useless on sand and snow. A tire at 30 PSI that feels great on the road will dig in, sink, and stall on soft sand. The same tire at 12 PSI will float right over. Popular fat-tire e-bike models like the [Rad Power RadRunner Plus](/models/rad-power-radrunner-plus) and [Lectric XP 3](/models/lectric-xp-3) are well-suited for sand and snow riding with proper PSI adjustments.
...
Popular e-bikes like the [Lectric XP 3](/models/lectric-xp-3) and [Aventon Aventure 2](/models/aventon-aventure-2) are commonly ridden on sand and snow. also handle the extra weight of the motor and battery better on soft surfaces, since the lower pressure keeps the larger contact patch more stable.
