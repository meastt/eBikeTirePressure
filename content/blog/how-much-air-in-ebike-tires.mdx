...
For cargo e-bikes like the [RadWagon](/models/rad-power-radwagon-4) or [Tern GSD](/models/tern-gsd-s10), check the manufacturer's recommendation first, then adjust for your actual load. These bikes are designed for weight, but the tires still need the right pressure to handle it safely.
