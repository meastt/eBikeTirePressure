...
Fat tires excel on sand and snow by running pressures that would pinch-flat a standard tire. But how low is too low? This guide covers the sweet spot between maximum traction and rim damage. Popular fat-tire e-bike models like the [Rad Power RadRunner Plus](/models/rad-power-radrunner-plus) and [Lectric XP 3](/models/lectric-xp-3) are ideal for sand and snow riding when pressure is set correctly.
...
### Motor Weight
E-bikes weigh 50-80 lbs vs. 30-35 lbs for analog fat bikes. Popular fat-tire e-bikes like the [Lectric XP 3](/models/lectric-xp-3) and [Aventon Aventure 2](/models/aventon-aventure-2) require these adjustments. Extra weight requires:
...
Select your model — like the [Lectric XP 3](/models/lectric-xp-3), [Aventon Aventure 2](/models/aventon-aventure-2), or [EBC Model R](/models/ebc-model-r) — set terrain to "sand/snow," and see safe minimum PSI with warnings if you're below tire minimum. Calculator accounts for rider weight and tire width.
