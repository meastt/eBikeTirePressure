...
- **Heavy riders (250+ lbs):** 30-50% shorter tire life than lighter riders at the same PSI. This is especially true for heavy models like the [RadWagon 4](/models/rad-power-radwagon-4), [Tern GSD](/models/tern-gsd-s10), and [Lectric XP 3](/models/lectric-xp-3) which carry significant weight.
...
Budget tires (often the stock tires that come on entry-level e-bikes like the [Aventon Soltera 2](/models/aventon-soltera-2) or [RadPower RadCity 5](/models/rad-power-radcity-5-plus)) use cheaper rubber compounds and lighter casing plies. They wear faster and puncture easier.

Mid-tier tires from brands like Schwalbe, Maxxis, or WTB consistently show 2-3x the lifespan of budget stock tires in e-bike applications — a critical upgrade for anyone riding a [RadWagon](/models/rad-power-radwagon-5) or [Specialized Turbo Vado](/models/specialized-turbo-vado-sl).
