...
If you carry a backpack, groceries, or a passenger, your optimal PSI for range shifts up. More load = more tire deformation = more rolling resistance at any given PSI. This is especially true for cargo e-bikes like the [Tern GSD](/models/tern-gsd-s10) and [Tern HSD](/models/tern-hsd-p5i) which regularly carry 50+ lbs of additional load.
...
Find your exact optimal PSI for your setup using our calculator — it factors in your weight, cargo, terrain, and tire construction for a personalized recommendation. Whether you ride a [Tern GSD](/models/tern-gsd-s10), [RadPower RadWagon 5](/models/rad-power-radwagon-5), or [EBC All City](/models/electric-bike-company-model-r), we'll dial in your numbers.
