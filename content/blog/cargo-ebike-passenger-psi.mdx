...
Standard e-bike PSI recommendations don't account for 100+ lb load swings. Popular longtail and cargo models like the [Tern GSD](/models/tern-gsd-s10), [Tern HSD](/models/tern-hsd-p5i), and [Riese & Müller Load](/models/riese-muller-load-75) have very different weight distributions that require specific pressure adjustments.

## Load Distribution Basics

### Solo Rider (No Cargo)
Baseline PSI depends on rider weight and tire specs. Example for 180 lb rider on a [Tern GSD](/models/tern-gsd-s10):
- **Front:** 28 PSI
- **Rear:** 32 PSI
...
Select your cargo bike model and input exact weights for front/rear cargo. Calculator shows safe PSI ranges with warnings if you exceed tire limits.

Popular cargo bikes: [Tern GSD](/models/tern-gsd-s10), [Tern HSD](/models/tern-hsd-p5i), [Yuba Spicy Curry](/models/yuba-spicy-curry), [Riese & Müller Load](/models/riese-muller-load-75), [Ariel Rider Grizzly](/models/ariel-rider-grizzly).
